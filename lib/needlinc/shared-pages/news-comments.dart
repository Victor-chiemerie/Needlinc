                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("📍${selectCharacters(address!, 22)}",
                          style: const TextStyle(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                Text(
                                                  "${selectCharacters(commentList[index]['userName'], 15)}",
                                                  style: TextStyle(
                                                      fontSize: 14,
                                                      fontWeight:
                                                          FontWeight.bold),
                                            ...
                                            Text(
                                                ...
                                                style: TextStyle(
                                                    ...
                                                    fontWeight:
                                                        FontWeight.w600)),
                                            Text(
                                                "📍${selectCharacters(commentList[index]['address'], 15)}",
                                                style: TextStyle(
                                                    fontSize: 12,
                                                    color:
